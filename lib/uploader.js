...
var uploader = function ({ queue, items,numberOfProcess, fileFormats, customCallback,cbemailfunction, filePath }) {
    // console.log(config);
    ...
    manager(queue, items, fileFormats,numberOfProcess.itemsManagerProcess);
